...
public class AlphaInfluencer implements ParticleInfluencer {
	...
	/**
	 * Adds a alpha step value using linear interpolation to the chain of values
	 * used throughout the particles life span
	 * 
	 * @param alpha
	 */
	...
	/**
	 * Adds a alpha step value to the chain of values used throughout the
	 * particles life span
	 * 
	 * @param alpha
	 * @param interpolation
	...
	/**
	 * Animated texture should cycle and use the provided duration between
	 * frames (0 diables cycling)
	 * 
	 * @param fixedDuration
